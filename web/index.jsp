       ...
       <div class="container">
           <div class="c-input">
               <form name="check" action="${pageContext.request.contextPath}/tuMesa" method="POST">
                   ...
                   <input type="text"class="entrada"  name="invitado_id" value="" class="c-input">
                   <input type="submit" name="enviar" value="Buscar Mesa" class="boton">
               </form>
           </div>
           <div class="c-options">
               <button class="boton" onclick="window.location.href = '${pageContext.request.contextPath}/EventsAdmin.jsp';"> Admin Options </button>
