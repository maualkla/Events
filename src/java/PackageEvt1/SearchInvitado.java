    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(""
                    ...
                    + "</div>"
                    + "<div class=\"options\">"
                    + "<form action='UpdateInvitado' method=\"POST\">"
                     + " <p>ID de Invitado: "+invitado+" </p>"
                    + "<input class=\"entrada\" class='entrada' type=\"text\" value=\""+invitado+"\" name=\"invitado\" style='display:none;'>"
                    + " <p> Nombre </p>"
                    + "<input class=\"entrada\" class='entrada' type=\"text\" value=\""+nombre+"\" name=\"nombre\" required>"
                    + "<p> Mesa </p>"
                    + "<input class=\"entrada\" class='entrada' type=\"text\" value=\""+mesa+"\" name=\"mesa\" required>"
                    + "<p> Dentro </p>"
                    ...
                    + "</div>"
                    + " </div>"
                    + "<form action='DeleteInvitado' method='POST'>"
                        + "<input type='text' style='display:none;' value='"+invitado+"' name='invitado_id'>"
                        + "<input type='submit' class='boton' style='background-color: red' value='Borrar Registro' >"
                    + "</form>"
